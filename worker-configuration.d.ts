/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e5cc3020568352250161c84b4a1f99e7)
// Runtime types generated with workerd@1.20250617.0 2024-09-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		WEBAUTHN_APP_NAME: "testimonials-addon";
		WEBAUTHN_RP_ID: string;
		AUTH_SECRET_KEY: string;
		SESSION_DURABLE_OBJECT: DurableObjectNamespace<import("./src/worker").SessionDurableObject>;
		TESTIMONIALS_DURABLE_OBJECT: DurableObjectNamespace<import("./src/worker").TestimonialsDurableObject>;
		testimonials_addon: R2Bucket;
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
